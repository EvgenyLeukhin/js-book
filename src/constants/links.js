const links = {
  ...
  js: [
    ...
    { id: 1,  title: 'Class II X',    to: '/js/class2' },
    { id: 2,  title: 'Object',        to: '/js/object' },
    { id: 3,  title: 'Object II X',   to: '/js/object2' },
    { id: 4,  title: 'Function',      to: '/js/function' },
    { id: 5,  title: 'Function II X', to: '/js/function2' },
    { id: 6,  title: 'Array',         to: '/js/array' },
    { id: 7,  title: 'Array II',      to: '/js/array2' },
    { id: 8,  title: 'Server X',      to: '/js/server', divider: true },
    ...
    { id: 13, title: 'Storage X',     to: '/js/storage' },
    { id: 14, title: 'Methods X',     to: '/js/methods'},
