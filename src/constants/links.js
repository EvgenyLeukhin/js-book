const links = {
  ...
  api: [
    { id: 0, title: 'Запросы',      to: '/api/request' },
    { id: 1, title: 'Callback',     to: '/api/callback' },
    { id: 2, title: 'Promise',      to: '/api/promise' },
    { id: 3, title: 'Promise II',   to: '/api/promise2' },
    { id: 4, title: 'Fetch, Axios', to: '/api/fetch' },
    { id: 5, title:  'Server API',  to: '/api/server-api' },
    { id: 6, title:  'Fetch data',  to: '/api/fetch-data' },
  ],
