const links = {
  ...
  js: [
    ...
    { id: 10, title: 'Forms',         to: '/js/forms' },
    { id: 11, title: 'Storage X',     to: '/js/storage' },
    { id: 12, title: 'Script Tag',    to: '/js/script', divider: true  },
    { id: 13, title: 'Var/Let/Const', to: '/js/vars' },
    { id: 14, title: 'Types',         to: '/js/types' },
    { id: 15, title: 'String',        to: '/js/string' },
    { id: 16, title: 'Number',        to: '/js/number' },
    { id: 17, title: 'Boolean',       to: '/js/boolean' },
    { id: 18, title: 'Null & Un-ed',  to: '/js/null' },
    { id: 19, title: 'Math(+ / -)',   to: '/js/math' },
    { id: 20, title: 'Logic',         to: '/js/logic' },
    { id: 21, title: 'Cycles',        to: '/js/cycles' },
  ],
